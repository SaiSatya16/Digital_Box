    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final response = await http.post(
          Uri.parse('http://127.0.0.1:5000/complaint'),
        ...
        // Handle network or server connection error
        showDialog(
          context: context,
          builder: (BuildContext context) {
            return AlertDialog(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                        child: Text('Select a category'), value: ''),
                    DropdownMenuItem(
                    ...
                    DropdownMenuItem(child: Text('Loan'), value: 'Loan'),
                    DropdownMenuItem(
                        child: Text('Internet Banking'),
                        value: 'Internet Banking'),
                    DropdownMenuItem(
                        child: Text('Mobile Banking'), value: 'Mobile Banking'),
